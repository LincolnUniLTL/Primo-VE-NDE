...
Ths first dipslays the filter/facet pane by default. The pane becomes frozen and can't be minimised on a large screen, but can cam be minimised on a moblie device.
