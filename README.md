...
The first dipslays the filter/facet pane by default on the left hand side of the main results pane. The pane becomes frozen and can't be minimised on a large screen, but can can be minimised on a moblie device. We have not test this with the panel on the right had side
